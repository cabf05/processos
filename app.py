...
with col1:
    ...
    yes_label = st.text_input("Label for YES path (activity)", key="yes_label")
    no_label = st.text_input("Label for NO path (activity)", key="no_label")
...
with col3:
    ...
    if node_obj:
        ...
        if node_obj["type"] not in ["start", "end"]:
            ...
            st.caption("Start/End nodes cannot be deleted.")
